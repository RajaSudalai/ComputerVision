# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 21:02:12 2020
...
class labelme2coco(object):
    ...
    def data_transfer(self):
        ...
        print("Categories found : ", self.categories)  ### Raja
    ...
    def image(self, data, num):
        ...
        # img = utils.img_b64_to_arr(data["imageData"]) ### Raja delete

        # height, width = img.shape[:2] ### Raja delete
        height = data["imageHeight"]   ### Raja
        width = data["imageWidth"]   ### Raja
    ...
    def category(self, label):
        ...
        print ('finding category and catid: ', label[0], category["id"]) ### Raja        
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--labelme_images", help="Path to a folder containing labelme-images and labelme-annotation-json-files.",
        required=True
        )

    parser.add_argument(

        "--output", help="Output json file path.", default="trainval.json", required=True
